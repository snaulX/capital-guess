from tkinter import Tk, simpledialog, messagebox, Button, Label, Menu
from itertools import cycle
import sys
global a, b, n, testname, v
v = 'v 1.0.12'
def simpletest_for_cc():
    ...
    main_menu.add_command(label="Exit", command = lambda tk = tk: tk.destroy())
